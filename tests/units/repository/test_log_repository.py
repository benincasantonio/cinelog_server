...
class TestLogRepository:
    ...
    def test_find_logs_by_movie_id(
    ...
    def test_log_list_without_filters(
        self, movie_create_request: LogCreateRequest, user_id: str
    ):
        log = self.log_repository.create_log(user_id, movie_create_request)
    ...
    def test_log_list_for_one_year(
        self, movie_create_request: LogCreateRequest, user_id: str
    ):
        log = self.log_repository.create_log(user_id, movie_create_request)
        ...
        logs_2024 = self.log_repository.find_logs_by_user_id(
            user_id, log_list_request_2024
        )

        assert len(logs_2024) == 0

    def test_sort_by_date_watched(
        self, movie_create_request: LogCreateRequest, user_id: str
    ):
    ...
    def test_log_list_with_watched_where_filter(
        self,
        ...
        log1 = self.log_repository.create_log(user_id, movie_create_request)
        log2 = self.log_repository.create_log(
    ...
    def test_find_log_by_id_success(
        self, movie_create_request: LogCreateRequest, user_id: str
    ):
    ...
    def test_update_log_not_found(self, user_id: str):
        ...
        result = self.log_repository.update_log(
            non_existent_id, user_id, update_request
        )
    ...
    def test_find_logs_by_user_id_without_request(
        self, movie_create_request: LogCreateRequest, user_id: str
    ):
    ...
    def test_find_logs_by_movie_id_with_user_filter(
        self, movie_create_request: LogCreateRequest, user_id: str
    ):
        ...
        logs = self.log_repository.find_logs_by_movie_id(
