...
- `OUTBOUND_MESSAGE_BATCH_SIZE`, `OUTBOUND_MESSAGE_POLL_INTERVAL_SECONDS`, `OUTBOUND_MESSAGE_LOCK_TIMEOUT_SECONDS`, `OUTBOUND_MESSAGE_MAX_RETRIES`, `OUTBOUND_MESSAGE_RETRY_BASE_SECONDS`, `OUTBOUND_MESSAGE_RETRY_MAX_SECONDS`: outbound-message delivery worker tuning — see [Outbound Email Delivery](docs/technical/outbound-email-delivery.md)
